...
public class FileDocument
{
	...
	public static system.proxies.FileDocument initialize(com.mendix.systemwideinterfaces.core.IContext context, com.mendix.systemwideinterfaces.core.IMendixObject mendixObject)
	{
		...
		if (com.mendix.core.Core.isSubClassOf("JWT.JWTRSAPrivateKey", mendixObject.getType()))
			return jwt.proxies.JWTRSAPrivateKey.initialize(context, mendixObject);

		if (com.mendix.core.Core.isSubClassOf("JWT.JWTRSAPublicKey", mendixObject.getType()))
